                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="autocomplete" placeholder="Enter your address" onFocus="geolocate()" name="autocomplete" value="{{ old('autocomplete') ?? ($registration->address ? $registration->address->street_number . ' ' . $registration->address->street_name . ', ' . $registration->address->locality . ', ' . $registration->address->state->abbr : '') }}">
