...
You have been scheduled for an appointment for your COVID-19 vaccination!  Your appointment is at {{ $location->address . ' ' . $location->city . ', ' . $location->state . ' ' . $location->zip }} between {{ \Carbon\Carbon::parse($slot->starting_at)->format('h:iA') . '-' . \Carbon\Carbon::parse($slot->ending_at)->format('h:iA') }}.  Please do not arrive early or late to avoid backing up traffic.
