...
<tr>
    ...
    <td><span title="{{ Carbon\Carbon::parse($res->registration->submitted_at)->format('h:i:s A') }}">{{ $res->registration ? Carbon\Carbon::parse($res->registration->submitted_at)->format('m-d-Y') : 'No registration' }}</span></td>    
