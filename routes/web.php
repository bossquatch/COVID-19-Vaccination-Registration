...
Route::group(["middleware" => "check.reset"], function() {
	...
	Route::get('/events/{id}/all/report', [App\Http\Controllers\EventController::class, 'allInvitesReport'])->middleware('can:update_invite');
    Route::get('/events/{event_id}/list', [App\Http\Controllers\EventController::class, 'inviteList']);
