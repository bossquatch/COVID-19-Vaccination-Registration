...
class VaccineDetailsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \App\Models\InjectionRoute::insert([
            ...
            ['id' => 7, 'description' => 'OTHER', 'abbrev' => 'OTH', 'created_at' => now(), 'updated_at' => now()],
        ]); 

        // Injection Sites
        \App\Models\InjectionSite::insert([
            ['id' => 1, 'description' => 'LEFT ANTERIOR THIGH', 'abbrev' => 'LAT', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 2, 'description' => 'LEFT ARM', 'abbrev' => 'LA', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 3, 'description' => 'LEFT DELTOID', 'abbrev' => 'LDT', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 4, 'description' => 'LEFT DELTOID', 'abbrev' => 'LD', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 5, 'description' => 'LEFT GLUTEOUS MEDIUS', 'abbrev' => 'LG', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 6, 'description' => 'LEFT LATERAL THIGH', 'abbrev' => 'LLT', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 7, 'description' => 'LEFT LOWER FOREARM', 'abbrev' => 'LLFA', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 8, 'description' => 'LEFT THIGH', 'abbrev' => 'LT', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 9, 'description' => 'LEFT TRICEPS', 'abbrev' => 'LTR', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 10, 'description' => 'LEFT VASTUS LATERALIS', 'abbrev' => 'LVL', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 11, 'description' => 'RIGHT ANTERIOR THIGH', 'abbrev' => 'RAT', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 12, 'description' => 'RIGHT ARM', 'abbrev' => 'RA', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 13, 'description' => 'RIGHT DELTOID', 'abbrev' => 'RDT', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 14, 'description' => 'RIGHT DELTOID', 'abbrev' => 'RD', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 15, 'description' => 'RIGHT GLUTEOUS MEDIUS', 'abbrev' => 'RG', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 16, 'description' => 'RIGHT LATERAL THIGH', 'abbrev' => 'RLT', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 17, 'description' => 'RIGHT LOWER FOREARM', 'abbrev' => 'RLFA', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 18, 'description' => 'RIGHT THIGH', 'abbrev' => 'RT', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 19, 'description' => 'RIGHT TRICEPS', 'abbrev' => 'RTR', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 20, 'description' => 'RIGHT VASTUS LATERALIS', 'abbrev' => 'RVL', 'created_at' => now(), 'updated_at' => now()],
        ]); 
